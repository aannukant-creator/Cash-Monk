...
function PaymentPageComponent() {
    ...
    const upiLink = `upi://pay?pa=${UpiId}&am=${amount}&cu=INR&tn=Recharge for Cesh Monk`;
            ...
            <main className="p-4">
                <Tabs defaultValue="direct" className="w-full">
                    <TabsList className="grid w-full grid-cols-2">
                        ...
                        <TabsTrigger value="qrcode">Scan QRCode</TabsTrigger>
                    </TabsList>
                    ...
                    <TabsContent value="qrcode">
                         <Card className="mt-4">
                            <CardContent className="p-4 flex flex-col items-center justify-center">
                                <p className="font-semibold mb-2">Scan this QR Code to Pay</p>
                                <Image 
                                    src={qrCodeUrl} 
                                    alt="UPI QR Code" 
                                    width={250} 
                                ...
                                />
                                <p className="text-sm text-gray-500 mt-4">Payable Amount: <span className="font-bold">₹{amount}</span></p>
                                <p className="text-xs text-center text-gray-500 mt-2">After payment, please enter the UTR/Reference ID on the 'Direct Transfer' tab.</p>
                            </CardContent>
                        </Card>
                    </TabsContent>
                </Tabs>
